...
async def rotate_pty(session_id: str, request: Request):
    ...
    registry, _config_obj, mcp_config = _load_registry_and_mcp_config()
    ...
    # The respawn took the pane's screen and scrollback with it. What was on
    # that screen is replayed by the gateway, to the browser tile, as a banner
    # beside the terminal — not from here and not into the pane, which the
    # harness owns and repaints.
