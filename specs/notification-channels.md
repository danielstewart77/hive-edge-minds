...
**Never call notify_owner in a live interactive session.** The user is already present in the conversation. Sending a Telegram notification while they're talking to you is redundant and noisy.
