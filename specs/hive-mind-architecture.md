...
### Events
Anything that kicks off work: a user message, a Telegram command, a webhook,
a Stop hook. Events are thin — they identify what happened and invoke the
appropriate skill.
...
When writing story cards for Hive Mind development, every story that involves
