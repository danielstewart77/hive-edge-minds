...
from bots.skills import _resolve_skills_dir, get_skills
...
class TestGatewayClientInterrupt:
    ...
    async def test_interrupt_session_calls_correct_endpoint(self, gateway):
        ...
        # Bearer-auth was added in Phase A5: GatewayClient always passes headers=
        # (empty dict when no bearer is configured).
