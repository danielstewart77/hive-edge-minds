"""Claude CLI + Ollama models template.

Tested. Based on Bob's implementation.
Spawns a `claude` CLI subprocess in stream-json mode. Ollama env var
injection (ANTHROPIC_AUTH_TOKEN, ANTHROPIC_BASE_URL) is handled by the
ModelRegistry — the implementation is identical to claude_cli_claude.
"""
