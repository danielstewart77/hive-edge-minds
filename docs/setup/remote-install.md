...
```bash
# Via remote shell:
claude /plugin marketplace add <your-marketplace>/hivemind-plugin
```
...
- **Container hostname:** From inside a mind container, the bridge is at `http://hive-mind-remote-admin:8430`, not `localhost:8430`.
