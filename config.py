...
def _get_secret(key: str, default: str = "") -> str:
    """Get a secret from the environment. Keyring layer was retired in Phase B6."""
...
class HiveMindConfig:
    ...
    telegram_owner_chat_id: int = 0  # DM chat ID for owner notifications

    # Discord bot
    discord_allowed_users: list[int] = field(default_factory=list)
    discord_allowed_channels: list[int] = field(default_factory=list)  # empty = all
